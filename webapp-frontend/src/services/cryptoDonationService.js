...
export const CRYPTO_TYPES = [
  ...
  { value: 'USDT-Polygon', text: 'USDT (Polygon)', icon: 'mdi-currency-usd' },
  { value: 'USDT-ArbitrumOne', text: 'USDT (Arbitrum One)', icon: 'mdi-currency-usd' },
  { value: 'USDT-BSC', text: 'USDT (BSC)', icon: 'mdi-currency-usd' }
]
