...
DEFAULT_WHEEL_CONFIG = LuckyWheelConfig(
    items=[
        ...
        LuckyWheelItem(name="积分 +15", probability=30.0),
        LuckyWheelItem(name="积分 -5", probability=25.0),
        LuckyWheelItem(name="积分 +40", probability=15.0),
        LuckyWheelItem(name="积分 -20", probability=10.0),
        LuckyWheelItem(name="邀请码 1 枚", probability=0.5),
        LuckyWheelItem(name="积分 +100", probability=1.4),
        LuckyWheelItem(name="积分 -100", probability=1.6),
        LuckyWheelItem(name="积分翻倍", probability=0.7),
        LuckyWheelItem(name="积分 -200", probability=0.8),
    ],
    cost_credits=10,
